...
PATTERNS = (
  '^(?!.*/\.)(?!.*\.\.)(?!/)(?!.*//)(?!.*@\{)(?!.*\\)[^\040\177 ~^:?*[]+/[^\040\177 ~^:?*[]+(?<!\.lock)(?<!/)(?<!\.)$', # Joey v1
  '^(?!build-)(?!.*/\.)(?!.*\.\.)(?!/)(?!.*//)(?!.*@\{)(?!.*\\)[^\040\177 ~^:?*[]+/[^\040\177 ~^:?*[]+(?<!\.lock)(?<!/)(?<!\.)$', # Joey v2
  '^(?!build-|/|.*([/.]\.|//|@\{|\\))[^\040\177 ~^:?*[]+/[^\040\177 ~^:?*[]+(?<!\.lock|[/.])$', # Joey v3
  'refs/heads/(?!.)(?!build-)((?!\.\.)(?!@{)[^\cA-\cZ ~^:?*[\\])+)(?<!\.)(?<!\.lock)', # murgatroid99 v1
  '(?!.)((?!\.\.)(?!@{)[^\cA-\cZ ~^:?*[\\])+)(/(?!.)((?!\.\.)(?!@{)[^\cA-\cZ ~^:?*[\\])+))*?/(?!.)(?!build-)((?!\.\.)(?!@{)[^\cA-\cZ ~^:?*[\\])+)(?<!\.)(?<!\.lock)' # murgatroid99 v2
)
